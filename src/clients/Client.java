...
public class Client {
  ...
  public Client(boolean isAdult) {
    ...
    this.clientBill = BigDecimal.valueOf(0);
    this.clientTip = BigDecimal.valueOf(0);
    order = new Order();
  }
  ...
  public void calculateClientTip() {
    ...
    if (num > 5) {
      this.clientTip = this.clientBill.divide(BigDecimal.valueOf(10), 2, RoundingMode.HALF_UP);
    }
  }
